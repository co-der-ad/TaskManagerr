                    ...
                    <div class="row">
                        <div class="col-lg-8 col-11 mx-auto">
                            <form role="form" method="post">
                                ...
                                <button type="submit" name="submit" class="btn custom-btn form-control mt-4 mb-3">Create account</button>
                                <p class="text-center">Already have an account? Please <a href="signin.php">Sign In</a></p>
                            </form>
                        </div>
                    </div>
                </div>
